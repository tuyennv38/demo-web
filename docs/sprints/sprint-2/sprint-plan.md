...
|---|---------|------------|--------|-----------|--------|
| 1 | `task:setup-routing-0001` | `feature:routing-0001` | Cấu hình React Router cho các trang (Login, Dashboard) và logic guard authentication | 3h | ✅ Done (commit:setup-routing-0001) |
